...
public class DAO_DB_Artist implements IArtistDataAccess {
    private SQLController databaseConnector;

    public DAO_DB_Artist() throws IOException {
    ...
    public List<Artist> getAllArtist() throws Exception {
        ...
        {
            String sql = "SELECT * FROM SixAndTheMusic.dbo.Artist;";
    ...
    public Artist findArtistByName(String name) throws SQLException {
        ...
        String stmt = "SELECT * from SixAndTheMusic.dbo.Artist Where Lower(ArtistName) = Lower(?);";
    ...
    public Artist createArtist(Artist artist) throws Exception {
        String sql = "INSERT INTO SixAndTheMusic.dbo.Artist (ArtistName) VALUES (?);";
