...
public class DAO_DB_Songs implements ISongDataAccess {
    ...
    public List<Song> getAllSongs() throws Exception {
        ...
        {
            String sql = "SELECT * from SixAndTheMusic.dbo.Music\n" +
                    "join SixAndTheMusic.dbo.Genre G on Music.GenreID = G.GenreID\n" +
                    "left join SixAndTheMusic.dbo.Artist A on A.ArtistID = Music.ArtistID";
    ...
    public Song createSong(Song song) throws Exception {
        // SQL statement
        String sql = "INSERT INTO SixAndTheMusic.dbo.Songs (SongTitle, SongDuration, ArtistID, GenreID, FormatedTime, songPath) VALUES (?,?,?,?,?,?);";
    ...
    public Song updateSong(Song song) throws Exception {
        // SQL statement
        String sql = "UPDATE SixAndTheMusic.dbo.Music SET SongTitle = ?, SongDuration = ?, ArtistID = ?, GenreID = ? WHERE SongID = ?";
    ...
    public Song deleteSong(Song song) throws Exception {
        // SQL statement
        String deletePlaylistSongSQL = "delete from SixAndTheMusic.dbo.Playlist_Music where song_id = ?";
        String deleteSongSQL = "delete from SixAndTheMusic.dbo.Music WHERE song_id = ?";
