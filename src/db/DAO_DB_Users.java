...
public class DAO_DB_Users {
    ...
    public List<Users> getAllUsers() throws Exception {
        ...
        {
            String sql = "SELECT * FROM SixAndTheMusic.dbo.Users;";
    ...
    public Users createUser(Users users) throws Exception {
        // SQL statement
        String sql = "INSERT INTO SixAndTheMusic.dbo.Users (UserName, UserEmail, UserPassword) VALUES (?, ?, ?)";
    ...
    public Users updateUser(Users user) throws Exception {
        // SQL statement
        String sql = "update SixAndTheMusic.dbo.Users set UserName = ?, UserEmail = ?, UserPassword = ? where UserID = ?";
    ...
    public Users validateUser(String userName, String password){
         ...
         */
        String sql = "SELECT * from SixAndTheMusic.dbo.Users where UserName = ? and UserPassword = ?";
