...
public class DAO_DB_Playlists implements IPlaylistDataAccess {
    ...
    public List<Playlist> getAllPlaylists() throws Exception {
        ...
        {
            String sql = "SELECT * FROM SixAndTheMusic.dbo.Playlist;";
    ...
    public List<Playlist> getUserPlaylist(int userID) throws Exception {
        ...
        String sql =
                "SELECT p.playlist_id, p.PlaylistName " + // get is the p ID and p Name.
                        "FROM SixAndTheMusic.dbo.Playlist p " + // from the table Playlist
                        "JOIN SixAndTheMusic.dbo.UserPlaylist up ON p.playlist_id = up.playlist_id " + // joins with userp
